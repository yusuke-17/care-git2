  ...
  <body>
    <header>
      <nav class="navbar navbar-default navbar-expand-md navbar-light py-0 color__navi">
        ...
        <form name="form" action="admin_user_complete.php" method="POST">
        ...
        <input type="button" class="care-button" onclick="location.href='http://localhost/Care/admin_usernew.php'"  value="戻る">
        </div>
